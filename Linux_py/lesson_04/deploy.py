...
def deploy():
    res = []
    upload_files("0.0.0.0", "user2", "1111", "test/p7zip-full.deb", "/home/user2/p7zip-full.deb")
    res.append(ssh_checkout("0.0.0.0", "user2", "1111", "echo '1111' | sudo -S dpkg -i /home/user2/p7zip-full.deb",
                            "Настраивается пакет"))
    res.append(ssh_checkout("0.0.0.0", "usr2", "1111", "echo '1111' | sudo -S dpkg -s p7zip-full",
